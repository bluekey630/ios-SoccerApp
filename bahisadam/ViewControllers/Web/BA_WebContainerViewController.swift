...
class BA_WebContainerViewController: UIViewController, BA_FakeTabBarViewDelegate {
	...
	private var containerViewController: BA_ViewController?
	...
	override func viewWillAppear(_ animated: Bool) {
        ...
        self.showHideTabBar(show: false)
    ...
    */
	...
	func embedWebview(webViewRef: BA_ViewController, url: String, displayTabBar: Bool) {
		webViewRef.league = self.league
