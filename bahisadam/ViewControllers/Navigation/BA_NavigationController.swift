...
public class BA_NavigationController: UINavigationController, BA_MatchDetailContainerDelegate {
	...
	private var currentLoadedWebView: BA_ViewController?
    ...
    override public func viewDidLoad() {
		...
		self.currentLoadedWebView = self.storyboard?.instantiateViewController(withIdentifier: "BA_ViewController") as? BA_ViewController
	...
	*/
	...
	func getLoadedWebview() -> BA_ViewController? {
